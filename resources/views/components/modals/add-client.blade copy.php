    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body add-modal">
                <form method="POST" action="{{ route('client.add') }}" data-url="{{ route('client.add') }}"
                    class="formSubmit fileUpload" enctype="multipart/form-data" id="UserForm">
                    @csrf
                    {{-- <form id="add_Clientform"> --}}
                            ...
                            <div class="col-md-8 my-2 timing_row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Location"
                                        id="location" name="location[0]">
                                </div>
                                <div class="col-md-8 my-2 ml-3 sub_loc">
                                    <div class="form-group break_flex">
                                        <label for="location">Enter Sub-location</label>
                                        <input type="text" class="form-control" placeholder="Enter Location"
                                            id="sub_location" name="location[0][sub_location][0]">

                                        <a href="javascript:void(0)" class="add_sub_loc col-md-2" data-length="0"
                                            data-id="{{ $available_day['name'] ?? '' }}">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                </div>
                                <a href="javascript:void(0)" class="add_loc col-md-2" data-length="0"
                                    data-id="{{ $available_day['name'] ?? '' }}">
                                    <i class="fa fa-plus"></i>
                                </a>
                            </div>
