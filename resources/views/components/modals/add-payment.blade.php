<!-- Modal -->
<div class="modal fade" id="addPaymentmDetails" tabindex="-1" role="dialog" aria-labelledby="addPaymentTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body add-modal">
                <form method="POST" action="{{ route('payment_details.add') }}" data-url="{{ route('payment_details.add') }}"
